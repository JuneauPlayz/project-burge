...
@export var ally1 : Ally_COPY
@export var ally2 : Ally_COPY
@export var ally3 : Ally_COPY
@export var ally4 : Ally_COPY
@export var allies : Array = []
@export var enemy1 : Enemy_COPY
